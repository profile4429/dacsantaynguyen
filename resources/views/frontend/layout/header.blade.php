<!-- Header 1 - Top Header -->
<header class="navbar navbar-expand-lg text-white" style="background-color: #951E21">
    <div class="container">
        <div class="wrap-logo">
            <a href="#" style="display: flex; align-items: center;">
                <img style="max-width: 250px; height:auto" src="http://dacsantaynguyen.com/Content/images/logo.png"
                    alt="Logo">
            </a>
        </div>
