        ...
        <div class="row">
            <div class="col-12">
                <div class="bg-orange p-3">
                    <h4 class="text-center mb-0">Cảm ơn bạn đã đặt hàng! Vui lòng liên hệ 0367170448 để được hỗ trợ tốt nhất
                    </h4>
                    ...
                    <div class="justify-content-start">
                        ...
                        @switch($payment)
                            ...
                            @case(2)
                                ...
                                <p><strong>- Chủ tài khoản: Nguyen Van A</strong></p>
                                <p style="color: red"><strong>- Số tài khoản: 65610000188402</strong></p>
                                <p><strong>- Chi nhánh: DacLak</strong></p>
                                <p><strong>Số tiền cần thanh toán: <i style="color: red">{{ $format_total }}</i></strong></p>
